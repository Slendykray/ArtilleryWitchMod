...
namespace HenryMod.Survivors.Henry.Achievements
{
    ...
    {
        public const string identifier = HenrySurvivor.HENRY_PREFIX + "ArtilleristAirWisp";
        public const string unlockableIdentifier = HenrySurvivor.HENRY_PREFIX + "Skills.Artillerist.Cluster";
