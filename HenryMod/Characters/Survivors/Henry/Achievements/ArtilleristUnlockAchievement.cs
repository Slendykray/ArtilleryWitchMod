...
namespace HenryMod.Survivors.Henry.Achievements
{
    ...
    {
        public const string identifier = HenrySurvivor.HENRY_PREFIX + "ArtilleristUnlock";
        public const string unlockableIdentifier = HenrySurvivor.HENRY_PREFIX + "Characters.Artillerist";
