...
namespace HenryMod.Survivors.Henry.SkillStates
{
    public class ThrowNuke : BaseThrowBombState
    {
        ...
        {
            projectilePrefab = HenryAssets.nuke;
            ...
            if (charge >= 1f)
            {           
                nukeImpactExplosion.childrenProjectilePrefab = HenryAssets.fireDot;
            ...
            minDamageCoefficient = HenryStaticValues.nukeMinDamageCoefficient;
            maxDamageCoefficient = HenryStaticValues.nukeMaxDamageCoefficient;
