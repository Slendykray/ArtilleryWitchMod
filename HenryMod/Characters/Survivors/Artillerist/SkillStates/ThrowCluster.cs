...
{
    public class ThrowCluster : GenericProjectileBaseState
    {
        ...
        public static float DamageCoefficient = ArtilleristStaticValues.clusterDamageCoefficient;

        public override void OnEnter()
        {
            projectilePrefab = ArtilleristAssets.cluster;
