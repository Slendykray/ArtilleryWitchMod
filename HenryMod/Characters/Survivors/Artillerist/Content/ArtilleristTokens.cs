...
{
    public static class ArtilleristTokens
    {
        ...
        {
            string prefix = ArtilleristSurvivor.HENRY_PREFIX;
            ...
            #region Passive
            Language.Add(prefix + "PASSIVE_NAME", "Hover");
            Language.Add(prefix + "PASSIVE_DESCRIPTION", $"Holding the Jump key causes the Artillerist to {Tokens.UtilityText("hover in the air")}.");
            #endregion

            #region Primary
            Language.Add(prefix + "PRIMARY_MISSILE_NAME", "Missile");
            Language.Add(prefix + "PRIMARY_MISSILE_DESCRIPTION", $"Fire a small missile for {Tokens.DamageValueText(ArtilleristStaticValues.missileDamageCoefficient)}. Hold up to 3.");
            #endregion
            ...
            Language.Add(prefix + "UTILITY_FIREDASH_DESCRIPTION", $"Dash backwards leaving a napalm bomb in your place for {Tokens.DamageValueText(ArtilleristStaticValues.napalmDamageCoefficient)}, igniting a small area.");
            #endregion
            ...
            Language.Add(Tokens.GetAchievementNameToken(ArtilleristMasteryAchievement.identifier), "Artillerist: Mastery");
            Language.Add(Tokens.GetAchievementDescriptionToken(ArtilleristMasteryAchievement.identifier), "As Artillerist, beat the game or obliterate on Monsoon.");
