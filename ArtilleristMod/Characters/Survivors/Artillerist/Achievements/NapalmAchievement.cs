...
namespace ArtilleristMod.Survivors.Artillerist.Achievements
{
    ...
    {
        public const string identifier = ArtilleristSurvivor.HENRY_PREFIX + "ArtilleristBossFire";
        public const string unlockableIdentifier = ArtilleristSurvivor.HENRY_PREFIX + "Skills.Artillerist.Napalm";
