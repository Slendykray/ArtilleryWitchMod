...
{
    public class ArtilleristSurvivor : SurvivorBase<ArtilleristSurvivor>  
    {
        ...
        public const string HENRY_PREFIX = ArtilleristPlugin.DEVELOPER_PREFIX + "_ARTILLERIST_";
        ...
        public override void InitializeCharacter()
        {
            ...
            ArtilleristUnlockables.Init();

            base.InitializeCharacter();

            ArtilleristConfig.Init();
            ArtilleristStates.Init();
            ArtilleristTokens.Init();

            ArtilleristAssets.Init(assetBundle);
            ArtilleristBuffs.Init(assetBundle);
        ...
        {
            AddHitboxes();
            //ItemDisplayRuleSet itemDisplayRule = Addressables.LoadAssetAsync<GameObject>("RoR2/Base/Mage/MageBody.prefab").WaitForCompletion().GetComponent<ModelLocator>().modelTransform.GetComponent<CharacterModel>().itemDisplayRuleSet;
            //bodyPrefab.GetComponent<ModelLocator>().modelTransform.GetComponent<CharacterModel>().itemDisplayRuleSet = itemDisplayRule;
        ...
        private void AddSecondarySkills()
        {
            ...
            Skills.AddSkillToFamily(secondarySkillFamily, secondarySkillDef2, ArtilleristUnlockables.clusterUnlockableDef);
        }
        ...
        public override void InitializeCharacterMaster()
        {
            ...
            ArtilleristAI.Init(bodyPrefab, masterName);
        ...
        private void RecalculateStatsAPI_GetStatCoefficients(CharacterBody sender, R2API.RecalculateStatsAPI.StatHookEventArgs args)
        {
            ...
            if (sender.HasBuff(ArtilleristBuffs.armorBuff))
            {
                args.armorAdd += 300;
            }
        }
